...
cliente = {'nombre':'Brewin', 'apellido':'Sánchez', 'peso':73, 'altura':1.70}
...
print(dicc['c2'][1].upper()) #Busca en la clave c2, el elemento que se encuentra en el índice 1 y con .upper se convierte en mayúscula el elemento tipo string
